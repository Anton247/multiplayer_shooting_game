...
#include <string>
#include <utility>
#include "../GameEngine/engine/utils/Log.h"
#include "../GameEngine/engine/animation/Timeline.h"
#include "ShooterMsgType.h"
#include "../GameEngine/engine/animation/Animations.h"
#include "../GameEngine/engine/utils/EventHandler.h"
...
void ShooterClient::sendMessage(std::string message){
...
void ShooterClient::sendChatMessage(std::string message, std::string name) {
